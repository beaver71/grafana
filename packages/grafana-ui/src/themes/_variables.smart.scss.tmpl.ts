...
export const smartThemeVarsTemplate = (theme: GrafanaTheme) =>
  `${renderGeneratedFileBanner('grafana-ui/src/themes/smart.ts', 'grafana-ui/src/themes/_variables.smart.scss.tmpl.ts')}
// Global values
// --------------------------------------------------
