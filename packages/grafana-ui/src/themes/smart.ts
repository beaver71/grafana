...
const basicColors = {
  ...
  gray4: '#d8d9da',
  gray5: '#ececec',
  gray6: '#f4f5f8', // not used in smart theme
  gray7: '#fbfbfb', // not used in smart theme
  gray05: '#2f3b52c0',    // override default.ts
  gray10: '#1a202c',    // override default.ts
  redBase: '#e02f44',
  redShade: '#c4162a',
  greenBase: '#299c46',
  greenShade: '#23843b',
